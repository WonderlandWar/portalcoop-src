...
#define FLOOR_TURRET_PORTAL_EYE_ATTACHMENT 2
...
class C_NPC_Portal_CeilingTurret : public C_AI_BaseNPC
{
public:
	DECLARE_CLASS( C_NPC_Portal_CeilingTurret, C_AI_BaseNPC );
	DECLARE_CLIENTCLASS();

	virtual ~C_NPC_Portal_CeilingTurret( void );
...
IMPLEMENT_CLIENTCLASS_DT( C_NPC_Portal_CeilingTurret, DT_NPC_Portal_CeilingTurret, CNPC_Portal_CeilingTurret )
...
C_NPC_Portal_CeilingTurret::~C_NPC_Portal_CeilingTurret( void )
{
	LaserOff();
	if( m_pBeam )
		m_pBeam->Remove();
...
void C_NPC_Portal_CeilingTurret::Spawn( void )
{
	SetThink( &C_NPC_Portal_CeilingTurret::ClientThink );
...
void C_NPC_Portal_CeilingTurret::ClientThink( void )
{
...
void C_NPC_Portal_CeilingTurret::LaserOff( void )
{
	if( m_pBeam )
	{
...
void C_NPC_Portal_CeilingTurret::LaserOn( void )
{
...
float C_NPC_Portal_CeilingTurret::LaserEndPointSize( void )
{
