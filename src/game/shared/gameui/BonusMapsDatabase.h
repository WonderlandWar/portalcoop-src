...
extern ConVar sv_bonus_score_objective_bronze;
extern ConVar sv_bonus_score_objective_silver;
extern ConVar sv_bonus_score_objective_gold;
...
public:
	...
	void UnlockMap(const char* pszMapName);
	
	ChallengeDescription_t	m_CurrentChallengeObjectives;

	bool		m_bSavedDataChanged; //Was private, but access is needed
