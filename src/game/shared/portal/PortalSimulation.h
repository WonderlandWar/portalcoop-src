...
struct PS_SimulationData_t //compartmentalized data for coherent management
{
	...
	//CPSCollisionEntity *hCollisionEntity; //the entity we'll be tying physics objects to for collision
	...
	CHandle<CPSCollisionEntity> hCollisionEntity;
...
public:
	...
	//--------------------------------------------------
	//Is now shared for both client an server
	//--------------------------------------------------
...
//	const PS_InternalData_t &GetInternalData();
