...
class CWeaponBugBait : public CBasePortalCombatWeapon
{
	DECLARE_CLASS( CWeaponBugBait, CBasePortalCombatWeapon );
public:
...
LINK_ENTITY_TO_CLASS_ALIASED( weapon_bugbait, WeaponBugBait );
#ifndef HL2MP
