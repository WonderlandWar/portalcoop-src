...
#ifndef HL2MP
LINK_ENTITY_TO_CLASS_ALIASED( weapon_crowbar, WeaponCrowbar );
...
#ifdef PORTAL
		Ray_t ray;
		ray.Init(pOperator->Weapon_ShootPosition(), pHurt->GetAbsOrigin());
		UTIL_Portal_TraceRay(ray, MASK_SHOT_HULL, pOperator, COLLISION_GROUP_NONE, &traceHit);
#else
