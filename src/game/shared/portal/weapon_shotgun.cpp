...
class CWeaponShotgun : public CBasePortalCombatWeapon
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS( CWeaponShotgun, CBasePortalCombatWeapon );
	DECLARE_PREDICTABLE();
...
LINK_ENTITY_TO_CLASS_ALIASED( weapon_shotgun, WeaponShotgun );
