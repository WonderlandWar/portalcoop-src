...
class CWeaponPistol : public CBasePortalCombatWeapon
{
	DECLARE_DATADESC();

public:
	DECLARE_CLASS( CWeaponPistol, CBasePortalCombatWeapon );
...
LINK_ENTITY_TO_CLASS_ALIASED( weapon_pistol, WeaponPistol );
